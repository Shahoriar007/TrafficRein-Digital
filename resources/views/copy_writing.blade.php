                            ...
                            <div class="project-details_inner">
                                <div class="post_content">
									<div class="post-header">
										<h3 class="post-title">Web Development Service</h3>
									</div>
									<div class="fulltext">
										<p>
											As a web development agency that specializes in creating, designing, and maintaining websites for clients. Here are some of the service details that a typical web development agency may offer:
										</p>
